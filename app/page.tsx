...
const config = {
  ...
  {
    text: "清晨的餐桌上，昨天我們玩到太晚，讓我整個就很沒精神",
...
7/9 是我第一次也是你第一次去貓咖，我們前一天晚上就一直在想要去哪裡好，原本計劃去看電影但最近檔期沒什麼好看的，原本又計畫要去大稻埕走一走順便洗戒指，但是不知道為啥沒去，最後決定去試試看貓咖，剛開始我以為都是宅男去的，但沒想到裡面蠻乾淨的也真的好多小隻的貓咪跑來跑去，看到你開心玩貓的臉，我就覺得很幸福，因為我又帶你創造了一個開心的時刻，沒想到後來因為我的疏忽，讓我們被迫中止我們開心的時間，立馬趕回去桃園。但幸運的是，我答應你的事情還是有做到！(圖K)
第六章｜一起出走：日本行
7/24是我最最最最最期待的日子，是我人生第一次第一次和女朋友出國，這是我希望做到的事情，因為我認為能跟女朋友出國玩，並不是在國內可以比擬的，除了行前的規劃、心理準備最重要的是要有一顆開心的心情，才能再出國的時候不生氣、不吵架開開心心結束出國行，在這幾天的旅途中我們有說有笑，雖然有時候你的行為真的會讓我很傻眼不知道怎麼說，但總而言之我們這幾天是開心的愉快的，拍美美的照片、吃好吃的東西以及努力夾了一個你很希歡的娃娃，喔對了，我們還有拍到你最想拍的照片「和服」，雖然當下有點吵架，但是我還是示好道歉，我們最後還是開開心心回來台灣。(圖L)
第七章｜慢步的日常
  ...
  const parseLongLetterToBlocks = (raw: string): Block[] => {
    ...
    for (const line of lines) {
      ...
      if (tail) {
        ...
        const softened = tail.replace(/一直吃東西/g, "肆無忌憚地相愛");
